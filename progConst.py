...
### launchpad X / mini mk3 sysex identifier
LAUNCHPADX_SYSEXID = 12
LAUNCHPADMINIMK3_SYSEXID = 13
...
SELECTEDTRACKL = [11, 21, 31, 41, 51, 61, 71, 81]
SELECTEDTRACKR = [12, 22, 32, 42, 52, 62, 72, 82]

FADERTRACK_VERTICAL = [14, 15, 24, 25, 34, 35, 44, 45, 54, 55, 64, 65, 74, 75, 84, 85]
FADERTRACK_HORIZONTAL = [51, 41, 52, 42, 53, 43, 54, 44, 55, 45, 56, 46, 57, 47, 58, 48]

SELECTEDTRACK_MUTE = 16
SELECTEDTRACK_ARMED = 26

SELECTEDTRACK_REVERSEPOLARITY = 27
SELECTEDTRACK_SWAPLEFTRIGHT = 17
...
CHANNELRACKSTEPEDITMODE_RETURN = 18
...
PATTERNRENAMECANCEL_PAD = 23

PATTERNCLONE_PAD = 11

MODES = [FLTRANSPORT_MODE, FLSNAP_MODE, MIXER_MODE, MIXERMASTER_MODE, CHANNELRACK_MODE, PATTERNS_MODE, BROWSER_MODE]
