...
character["1"] = PadGroup([42, 32, 22, 12])
character["2"] = PadGroup([42, 43, 33, 22, 12, 13])
character["3"] = PadGroup([41, 42, 43, 32, 33, 23, 11, 12, 13])
character["4"] = PadGroup([41, 31, 33, 21, 22, 23, 13])
character["5"] = PadGroup([42, 43, 32, 23, 12, 13])
character["6"] = PadGroup([42, 43, 32, 22, 23, 12, 13])
