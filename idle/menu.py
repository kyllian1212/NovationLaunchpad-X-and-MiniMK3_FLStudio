...
def menu():
    ...
    lp.lightPad(pc.FLSNAP_MENUPAD, pc.COLOR_DARK_GRAY if not pv.buttonPressed[pc.FLSNAP_MENUPAD] else pc.COLOR_WHITE, state)
    lp.lightPad(pc.MIXER_MENUPAD, pc.COLOR_DARK_GRAY if not pv.buttonPressed[pc.MIXER_MENUPAD] else pc.COLOR_WHITE, state)
    lp.lightPad(pc.MIXERMASTER_MENUPAD, pc.COLOR_DARK_GRAY if not pv.buttonPressed[pc.MIXERMASTER_MENUPAD] else pc.COLOR_WHITE, state)
